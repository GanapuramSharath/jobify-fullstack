...
var getApplicationStats = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var users, jobs;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                users = _a.sent();
                return [4 /*yield*/, prisma_1.prisma.job.count()];
            case 2:
                jobs = _a.sent();
                res.status(http_status_codes_1.StatusCodes.OK).json({
                    users: users,
...
var updateUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var obj, updatedUser, password, safeUser, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                obj = __assign({}, req.body);
                delete obj.password;
                if (req.file) {
            ...
            case 1:
                updatedUser = _a.sent();
                password = updatedUser.password, safeUser = __rest(updatedUser, ["password"]);
                res.status(http_status_codes_1.StatusCodes.OK).json({
                    msg: "user updated",
                    user: safeUser,
                });
            ...
            case 2:
                ...
                res.status(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR).json({
                    msg: error_1 instanceof Error ? error_1.message : "Something went wrong",
                });
                return [3 /*break*/, 3];
